    ...
    public class SignUpPageTests
    {
        ...
        public void SignUp()
        {
            using (IWebDriver driver = new FirefoxDriver())
            {
                ...
                IWebElement signUpButton = driver.FindElement(By.Id("submit_save"));
        ...
        public void SubmitApplication()
        {
            using (IWebDriver driver = new FirefoxDriver())
            {
                ...
                ////Fill some random unique name in Company name field
                IWebElement brokerNameInput = driver.FindElement(By.Id("broker_name"));

                brokerNameInput.SendKeys("MRK_Company");
